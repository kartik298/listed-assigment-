      ...
      <div className="card">
        <div className="login-container">
          ...
          <div className="button-group">
            <button onClick={loginWithGoogle}><Icon className='icon' icon="logos:google-icon" /> Sign with Google</button>
            <button onClick={loginWithGoogle}><Icon className='icon' icon="ic:baseline-apple" /> Sign with Apple</button>
          </div>
